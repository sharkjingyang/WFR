...
def OTFlowProblem_ex(x, rho_x, Phi, tspan, nt, stepper="rk4", alph=[1.0, 1.0, 1.0, 1.0], is_1d=False, alphaa=1,device=device):
    """
    ...
    # costC=KSD_IMQ(z[:, 0:2], z[:, -1].unsqueeze(1), c=1, l=1, beta=-0.5)+costC1
    # costC = costC1
