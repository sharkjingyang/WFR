...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        if itr % args.viz_freq == 0:
            ...
            with torch.no_grad():
                ...
                sPath = os.path.join(args.save, 'figs_penalty_checkerboard', start_time + '_{:04d}.png'.format(itr))
    ...
    np.save("experiments/cnf/toy/figs_penalty_checkerboard/total_loss.npy",np.array(record_loss_totol))
    np.save("experiments/cnf/toy/figs_penalty_checkerboard/L2_loss.npy",np.array(record_loss_L2))
