...
def plot4(net, x, y, nt_val, sPath, sTitle="", doPaths=False):
    ...
    np.save("C:/Users/shark/桌面/OT-Flow-master/OT_output/z_final.npy",X_p)
    np.save("C:/Users/shark/桌面/OT-Flow-master/OT_output/Gaussian_samples.npy",Gaussian_p)
    X_p_inverse=genModel1[:,0:d]
    np.save("C:/Users/shark/桌面/OT-Flow-master/OT_output/z_inverse.npy",X_p_inverse)
    np.save("C:/Users/shark/桌面/OT-Flow-master/OT_output/data_samples.npy",data_p)
    ...
    new_path="C:/Users/shark/桌面/OT-Flow-master/test_plot/fig_train_immediate.png"
