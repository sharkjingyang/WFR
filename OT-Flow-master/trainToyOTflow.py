...
parser.add_argument(
    '--data', choices=['swissroll', '8gaussians', 'pinwheel', 'circles', 'moons', '2spirals', 'checkerboard', 'rings','1d'],
    type=str, default='1d'
)
...
parser.add_argument('--sample_freq', type=int, default=2500)
    ...
    for itr in range(1, args.niters + 1):
        ...
        if itr % args.viz_freq == 0:
            with torch.no_grad():
                ...
                nSamples = 1000
                p_samples = cvt(torch.Tensor( toy_data.inf_train_gen(args.data, batch_size=nSamples) )).reshape(-1,d)
